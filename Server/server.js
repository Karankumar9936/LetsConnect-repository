...
// // --- 4. SOCKET.IO LOGIC (Privacy Upgraded) ---
...
//         try {
//             // 1. Save to Database with the UNIQUE room_id
//             await Message.create({
//                 room_id: data.room,          // Composite Key: "campaignId_influencerId"
//                 campaign_id: data.campaign_id,
//                 sender_id: data.sender_id,
//                 message_text: data.message
//             });

//             // 2. Broadcast ONLY to the specific users in that unique room
//             // data.room ensures test@gmail.com and demoInfluencer@gmail.com stay separated
...
// --- 3. SOCKET.IO SETUP (SOCKET CORS FIX) ---
const io = new Server(server, {
    cors: {
        origin: [
            "https://letsconnect99.netlify.app", 
